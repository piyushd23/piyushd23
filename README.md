...
Final-year **Computer Engineering** student with hands-on experience in **UI/UX Design**, **Web & App Development**, and **Product Design**. I love building products that blend **technical depth**, **clean UX**, and **real-world usability**.
Skilled in the **end-to-end product lifecycle** — research, ideation, design, development, testing, and delivery — while collaborating with cross-functional teams to align **business goals** with **user needs**.
...
* Strengthening **UI/UX design systems**
* Creating polished **full-stack product experiences**
* Exploring **GenAI & multimodal AI**

---

## 📬 **Let’s Connect!**

If you're interested in **collaborations**, **internships**, or **projects**, feel free to reach out. Always excited to build meaningful products!
